  ...
  <div class="login_container">
    ...
    <div class="login_box">
      ...
      <div class="avatar_box">
        <img src="https://th.bing.com/th/id/OIP._CE6cRfhf72W-38E26N6gQHaHa?pid=ImgDet&rs=1" alt="" />
      </div>
      <!-- 登录表单区域 -->
    ...
    <div class="footer2">
      <p>
      <p>
        ©2023-2077 By 雨伞下的米粒<br /><a href="https://beian.miit.gov.cn">备案号:浙ICP备2023074182号</a>
      </p>
      </p>
    </div>
  </div>
...
.login_container {
  ...
  background: url(https://img.zcool.cn/community/018fd45d2ed0f5a80120695c6fe1a1.jpg@1280w_1l_2o_100sh.jpg) no-repeat 0px 0px;
